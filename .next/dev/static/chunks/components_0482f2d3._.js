...
_s1(ThemeProvider, "MOCvl6iGOxSkmATsuDSc6CWgskg=");
_c = ThemeProvider;
var _c;
...
function Navbar() {
    _s();
    const { toggleTheme } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ThemeProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"])();
...
_s(Navbar, "nFmp9U9OdAF29Jqg5v+pDj8HwEs=", false, function() {
    return [
...
"[project]/components/ParticleNetwork.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ParticleNetwork() {
    ...
    const themeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])("dark");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ParticleNetwork.useEffect": ()=>{
            ...
            const onMove = {
                "ParticleNetwork.useEffect.onMove": (e)=>{
                    mouseRef.current = {
                        x: e.clientX,
                        y: e.clientY
                    };
                }
            }["ParticleNetwork.useEffect.onMove"];
            const onLeave = {
                "ParticleNetwork.useEffect.onLeave": ()=>{
                    mouseRef.current = {
                        x: -9999,
                        y: -9999
                    };
...
_s(ParticleNetwork, "cxwZnYqRTYQpc95dmJ66umDjB5U=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ThemeProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"]
    ];
});
...
//# sourceMappingURL=components_0482f2d3._.js.map